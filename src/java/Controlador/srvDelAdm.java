...
public class srvDelAdm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      try{
            ...
            if(!control.equals("")){
               // CREACION DEL OBJETO Y EJECUCION DEL METODO DEL
               clsAdministrador objAdministrador = new clsAdministrador();
               Connection cnn = objAdministrador.conexion();
               ResultSet rs;
               rs = objAdministrador.spDelAlumno(control);
               rs.next();
               request.getSession().setAttribute("delAlumno", rs);
           ...
           Logger.getLogger(srvDelAdm.class.getName()).
