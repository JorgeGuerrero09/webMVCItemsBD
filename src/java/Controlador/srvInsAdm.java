 ...
 * @author checo
 */
public class srvInsAdm extends HttpServlet {
    ...
    try{
            String control, nombre, paterno, materno, carrera, semestre, telefono, pwd;
            ...
            if(request.getParameter("txtContrasena") == null)
               ...
               pwd = request.getParameter("txtContrasena");
            if(!control.equals("") && !nombre.equals("") && !paterno.equals("") && !materno.equals("") && !carrera.equals("") 
                    && !semestre.equals("") && !telefono.equals("") && !pwd.equals("")){
               ...
               ResultSet rs;
               rs = objAdministrador.spInsAlumno(control, nombre, paterno, materno, carrera, semestre, telefono, pwd);
               rs.next();
           ...
           Logger.getLogger(srvInsAdm.class.getName()).
